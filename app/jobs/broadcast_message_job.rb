class BroadcastMessageJob < ApplicationJob
  ...
  def perform(message, sender_id, conversation_id)
    ...
    rendered_message_html = renderer.render(partial: "messages/message", locals: { message: message, default_url_options: { host: Rails.application.credentials[:host], protocol: 'https' } })
